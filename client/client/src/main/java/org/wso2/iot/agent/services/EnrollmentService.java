...
import org.wso2.iot.agent.EnableDeviceAdminActivity;
    ...
    private void getConfigurationsFromServer() {
        ...
        if (!ipSaved.isEmpty()) {
            ...
            CommonUtils.callSecuredAPI(EnrollmentService.this,
                                       ...
                                       org.wso2.iot.agent.proxy.utils.Constants.HTTP_METHODS.GET, null, EnrollmentService.this,
        ...
        if (CommonUtils.isNetworkAvailable(context)) {
            ...
            if (!ipSaved.isEmpty()) {
                ...
                CommonUtils.callSecuredAPI(EnrollmentService.this,
                                           ...
                                           org.wso2.iot.agent.proxy.utils.Constants.HTTP_METHODS.POST,
